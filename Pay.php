...
<?php
    ...
    if(isset($_POST['submit_cash'])){
		...
		//$query = "SELECT CONCAT('Name', '(',qty,')') FROM cart";
		
		$sql = "INSERT INTO cash_order (name,email,contactno,address,total,Approval) VALUES ('$name' , '$email' , '$no' , '$address' , '$total' , 'Yes' ) ";
		...
		if(mysqli_query($con,$sql)){
			...
			foreach($_SESSION['cart'] as $key => $values){
				...
				$sql="INSERT INTO tbl_orderdetail (order_ID,Product_Name,Quantity,SubTotal) VALUES (".$orderid.", '".$values['name']."', ".$values['qty'].", ".$SubTotal." )";
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 px-4 pb-4" id="order">
        ...
        <!--<h5><b>Total Amount Payable : </b><input type="text1" name="txtTotal" value="<?php //echo $total; ?>">/-</h5>-->
         ...
         <br/>
          <div class="form-group">
          	<button type="submit" name="submit_cash" class="w3-btn w3-teal" style="font-size: 16px;" ><b>Pay On Cash</b></button>
